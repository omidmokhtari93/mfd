            ...
            var ff = function (ajr) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        !e.haserror && ((orderType == '65' ? robOrderBtn.innerHTML = 'درخواست خرید' : robOrderBtn.innerHTML = 'درخواست فروش'))
